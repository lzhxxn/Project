               ...
               <div class="col-lg-8 posts-list">
                  <div class="single-post">
                     <div class="feature-img">
                        <img class="img-fluid" src="assets/img/blog/single_blog_6.png" alt="">
                     </div>
                     <div class="blog_details">
                        ...
                        <p class="excert">
						                           한동안 문화생활과는 거리가 꽤 있었던 일상!
						
						전시회나 행사는 커녕 마지막으로 영화관 가본게
						
						도대체 언제인지 기억이 가물가물할 정도예요 :(
						
						​
						
						거리두기 단계가 격상되기 전,
						
						날씨도 추워지기 전에 다녀왔던 #DDP #팀랩라이프!				
						다녀오자마자 포스팅 해야지, 해야지, 생각만 했었는데
						요즘 집에만 있었더니 너무 답답해서ㅜㅜ
						뒤늦게 포스팅 후기 올려보며
						
						집에만 콕 박혀있는 답답함을 좀 해소해보려고 해요ㅎㅎ
                        </p>
                        <div class="quote-wrapper">
                           <div class="quotes">
                              DDP 팀랩라이프

teamLab:LIFE 다녀온 뒤늦은 후기!
                           </div>
                        </div>
                        <div class="feature-img">
                        <img class="img-fluid" src="assets/img/blog/single_blog_11.png" alt="">
                     </div>
                        <p>
					                          어느날 친구가 DDP 팀랩라이프 가고싶다고하길래
					
					급하게 약속을 잡고 금요일 낮시간에 다녀왔었어요!
					
					사실 평일 낮인데도 사람이 꽤 많아서 당황스러웠던 기억이 있네요ㅎㅎ
                        </p>
                        <div class="feature-img">
                        <img class="img-fluid" src="assets/img/blog/single_blog_12.png" alt="">
                     </div>
                        <p class="excert">
						                           오랜만에 가본 DDP!

						이날 무슨 다른 행사도 있었는지 행사진행요원분들이랑
