                                                   ...
                                                   <c:otherwise>
                                                      <c:choose>
                                                         <c:when test="${LOGINUSER.m_verify eq 0}">
                                                            <a href="logout.do" style="padding: inherit;font-size: 100%; margin-top: 7%;"><i class="ti-user"></i>${LOGINUSER.m_name}님 로그아웃</a>
                                                         ...
                                                         <c:otherwise>
                                                             <a href="logout.do" style="padding: inherit;font-size: 100%; margin-top: 7%;"><i class="ti-user"></i>관리자님 로그아웃</a>
					...
					<div class="row justify-content-center">
						<div class="col-lg-10 col-md-8" align="center">
							...
							<form action="write" method="post" enctype="multipart/form-data">
								...
								<div class="mt-10 mb-20">
									<input name='file' type='file' class="genric-btn default" style="width:782px;text-align: left;padding-left: 1%;"><br/> <!-- Choose File -->
								</div>
								...
								<div class="form-group mt-3">
									<div>
	                                	<input type="submit" id="submitBtn" class="btn btn-sm btn-primary" value="저장" >
	                                </div>
	                            </div>
							</form>
						</div>
