				...
				<div class="section-top-border">
					<div class="row justify-content-center">
						<div class="col-lg-10 col-md-8">
							...
							<!--<c:choose>
									<c:when test="${ review.b_img != null }">
										<div>
											<input type="hidden" name="file" value="resources/upload/${ review.b_img }" />
										</div>
									</c:when>
									<c:otherwise>
										<div class="mt-10 mb-20">
											<input type="file" name="file" value="resources/upload/${ review.b_img }" accept=".png, .jpg, .jpeg" class="genric-btn default"/>
										</div>
									</c:otherwise>
								</c:choose>  -->	
								<div class="mt-10 mb-20">
									<input type="file" name="file" accept=".png, .jpg, .jpeg" class="genric-btn default"/>
								</div>
								<div class="mt-10 mb-20">
									...
									class="single-input" style="width:50%" value="${ review.b_subject }">
								</div>
							...
							<!--<div class="mt-10 mb-20">
									<input name='file' type='file' style="width:50%;" accept=".png, .jpg, .jpeg">${ review.b_img }<br/>
								</div>  -->	
